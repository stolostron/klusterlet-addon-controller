...
import (
	...
	cisctrl "github.com/open-cluster-management/endpoint-operator/pkg/components/ciscontroller/v1"
...
var componentsArray = []string{appmgr.AppMgr, certpolicyctrl.CertPolicyCtrl, cisctrl.CISCtrl,
...
func checkComponentIsEnabled(componentName string, klusterletaddonconfig *agentv1.KlusterletAddonConfig) (bool, error) {
	...
	case cisctrl.CISCtrl:
		return cisctrl.IsEnabled(klusterletaddonconfig), nil
...
func newCRManifestWork(
	...
	case cisctrl.CISCtrl:
		cr, err = cisctrl.NewCISControllerCR(klusterletaddonconfig, addonoperator.KlusterletAddonNamespace)
	case iampolicyctrl.IAMPolicyCtrl:
