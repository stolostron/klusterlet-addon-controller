...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KlusterletConnectionManager) DeepCopyInto(out *KlusterletConnectionManager) {
	*out = *in
	if in.BootStrapConfig != nil {
		in, out := &in.BootStrapConfig, &out.BootStrapConfig
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KlusterletConnectionManager.
func (in *KlusterletConnectionManager) DeepCopy() *KlusterletConnectionManager {
	if in == nil {
		return nil
	}
	out := new(KlusterletConnectionManager)
	in.DeepCopyInto(out)
	return out
}
