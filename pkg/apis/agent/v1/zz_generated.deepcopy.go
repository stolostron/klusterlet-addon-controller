...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KlusterletAddonConfigCISControllerSpec) DeepCopyInto(out *KlusterletAddonConfigCISControllerSpec) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KlusterletAddonConfigCISControllerSpec.
func (in *KlusterletAddonConfigCISControllerSpec) DeepCopy() *KlusterletAddonConfigCISControllerSpec {
	if in == nil {
		return nil
	}
	out := new(KlusterletAddonConfigCISControllerSpec)
	in.DeepCopyInto(out)
	return out
}
